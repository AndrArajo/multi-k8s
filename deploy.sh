...
kubectl set image deployments/client-deployment client=andrarajo/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=andrarajo/multi-worker:$SHA